      ...
      {inboxes.length > 0 && (
        ...
        >
          ...
          <button
            ...
            className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-xl text-[13px] font-bold transition-all border ${
              selectedInboxId === 'all'
          ...
          {inboxes.map(inbox => {
            ...
            return (
              <button
                ...
                className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-xl text-[13px] font-bold transition-all border whitespace-nowrap ${
                  isActive ? `${colorActive} shadow-md` : colorInactive
                }`}
              >
                <Icon />
