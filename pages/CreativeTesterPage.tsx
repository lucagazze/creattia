        ...
        <div>
          {status === 'idle' && !result && (
            <div className="flex flex-col items-center justify-center h-full min-h-[300px] gap-4 text-center">
              ...
              <p className="text-[14px] font-semibold text-zinc-500">Subí un creativo o elegí un anuncio</p>
            ...
            <div className="space-y-5">
              ...
              {result.actionItems?.length > 0 && (
                <div className="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-2xl p-5">
                  <p className="text-[11px] font-black text-zinc-500 uppercase tracking-wider mb-3 flex items-center gap-1.5">
