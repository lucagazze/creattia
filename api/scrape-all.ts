...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const { clientId, url, action, type, platform, shopify_domain, shopify_access_token, wordpress_url, woo_consumer_key, woo_consumer_secret, tiendanube_store_id, tiendanube_access_token } = req.body as any;
