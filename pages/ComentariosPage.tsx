          ...
          {(['all', 'instagram', 'facebook', 'ads'] as const).map(p => {
            ...
            return (
              ...
              >
                <span>{label}</span>
                {count > 0 && (
                  <span className={`inline-flex items-center justify-center min-w-[12px] h-[12px] sm:min-w-[15px] sm:h-[15px] px-0.5 rounded-full text-[7.5px] sm:text-[8.5px] font-black leading-none ${badgeColor}`}>
                    {count}
                  </span>
                )}
              </button>
              ...
              <div className={`${
                ...
                {!loadingComments && comments.length > 0 && (
                  <div className="flex items-center gap-1 px-5 pt-4 pb-3 border-b border-zinc-100 dark:border-zinc-800 flex-shrink-0 bg-zinc-50/50 dark:bg-zinc-900/40">
                    ...
                    >
                      Sin responder
                      <span className={`text-[7.5px] sm:text-[8.5px] min-w-[12px] h-[12px] sm:min-w-[15px] sm:h-[15px] px-0.5 rounded-full font-black flex items-center justify-center ${
                        commentFilter === 'pending'
